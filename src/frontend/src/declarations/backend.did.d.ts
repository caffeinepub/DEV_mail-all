...
export interface CampaignInput { 'subject' : string, 'body' : string }
...
export interface _SERVICE {
  ...
  'addSubscriber' : ActorMethod<[string, string], undefined>,
  'assignCallerUserRole' : ActorMethod<[Principal, UserRole], undefined>,
  'getCallerUserProfile' : ActorMethod<[], [] | [UserProfile]>,
  'getCallerUserRole' : ActorMethod<[], UserRole>,
  'getDashboardStats' : ActorMethod<
    [],
    { 'totalCampaignsSent' : bigint, 'totalSubscribers' : bigint }
  >,
  ...
  'sendCampaign' : ActorMethod<[CampaignInput], bigint>,
}
